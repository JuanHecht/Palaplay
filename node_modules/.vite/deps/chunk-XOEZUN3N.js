import {
  ...
  useRootElementName,
  useSlotProps
} from "./chunk-G23KV6EA.js";
import {
  useTheme
} from "./chunk-GR2MCS3J.js";
import {
  Transition_default,
  useEventCallback_default as useEventCallback_default2,
  useForkRef_default,
  useIsFocusVisible_default
} from "./chunk-FK4L5AVU.js";
import {
  require_react_dom
} from "./chunk-XBHG3ID7.js";
import {
  capitalize_default
} from "./chunk-FXC5JPW3.js";
import {
  HTMLElementType,
  Timeout,
  _extends,
...
var Slider = React50.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime30.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime29.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime29.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
...
var Grow = React72.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children,
  ...
  const autoTimeout = React72.useRef();
...
var _excluded29 = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"];
var PopperRoot = styled_default(Popper, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (props, styles3) => styles3.root
})({});
var Popper3 = React73.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
  ...
  return (0, import_jsx_runtime49.jsx)(PopperRoot, _extends({
    as: component,
...
var Tooltip = React74.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React74.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime50.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime51.jsxs)(React74.Fragment, {
    children: [React74.cloneElement(children, childrenProps), (0, import_jsx_runtime50.jsx)(PopperComponent, _extends({
      ...
      }) => (0, import_jsx_runtime50.jsx)(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: (0, import_jsx_runtime51.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow4 ? (0, import_jsx_runtime50.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
true ? Tooltip.propTypes = {
   ...
   * @default false
   */
  arrow: import_prop_types33.default.bool,
  /**
  ...
  components: import_prop_types33.default.shape({
    Arrow: import_prop_types33.default.elementType,
    Popper: import_prop_types33.default.elementType,
    Tooltip: import_prop_types33.default.elementType,
  ...
  componentsProps: import_prop_types33.default.shape({
    arrow: import_prop_types33.default.object,
    popper: import_prop_types33.default.object,
    tooltip: import_prop_types33.default.object,
    transition: import_prop_types33.default.object
  }),
  /**
   ...
   * @default false
   */
  describeChild: import_prop_types33.default.bool,
  /**
   * Do not respond to focus-visible events.
   * @default false
   */
  disableFocusListener: import_prop_types33.default.bool,
  /**
   * Do not respond to hover events.
   * @default false
   */
  disableHoverListener: import_prop_types33.default.bool,
  /**
   * Makes a tooltip not interactive, i.e. it will close when the user
   * hovers over the tooltip before the `leaveDelay` is expired.
   * @default false
   */
  disableInteractive: import_prop_types33.default.bool,
  /**
   * Do not respond to long press touch events.
   * @default false
   */
  disableTouchListener: import_prop_types33.default.bool,
  /**
   * The number of milliseconds to wait before showing the tooltip.
   * This prop won't impact the enter touch delay (`enterTouchDelay`).
   * @default 100
   */
  enterDelay: import_prop_types33.default.number,
  /**
   * The number of milliseconds to wait before showing the tooltip when one was already recently opened.
   * @default 0
   */
  enterNextDelay: import_prop_types33.default.number,
  /**
   * The number of milliseconds a user must touch the element before showing the tooltip.
   * @default 700
   */
  enterTouchDelay: import_prop_types33.default.number,
  /**
   * If `true`, the tooltip follow the cursor over the wrapped element.
   * @default false
   */
  followCursor: import_prop_types33.default.bool,
  /**
   ...
   * @default 0
   */
  leaveDelay: import_prop_types33.default.number,
  /**
   * The number of milliseconds after the user stops touching an element before hiding the tooltip.
   * @default 1500
   */
  leaveTouchDelay: import_prop_types33.default.number,
  /**
   * Callback fired when the component requests to be closed.
   *
   ...
   * @default Popper
   */
  PopperComponent: import_prop_types33.default.elementType,
  /**
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XOEZUN3N.js.map
